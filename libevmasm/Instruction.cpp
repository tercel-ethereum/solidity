...
std::map<std::string, Instruction> const solidity::evmasm::c_instructions =
{
	...
	{ "MYOPCODE", Instruction::MYOPCODE },
	{ "EXTOPENAPI", Instruction::EXTOPENAPI },
	{ "EXTSOPENAPI", Instruction::EXTSOPENAPI },
...
{ //												Add, Args, Ret, SideEffects, GasPriceTier
	...
	{ Instruction::RANDOM,	    { "RANDOM",		    0, 0, 1, true, Tier::Base } },
	{ Instruction::MYOPCODE,	{ "MYOPCODE",		0, 2, 1, true, Tier::Base } },
	{ Instruction::EXTOPENAPI,	{ "EXTOPENAPI",		0, 2, 2, true, Tier::Base } },
	{ Instruction::EXTSOPENAPI,	{ "EXTSOPENAPI",	0, 2, 3, true, Tier::Ext } },
